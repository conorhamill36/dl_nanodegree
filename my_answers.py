...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        self.weights_hidden_to_output = np.random.normal(0.0, self.hidden_nodes**-0.5, 
                                       (self.hidden_nodes, self.output_nodes)) #in "Implementing Backpropagation", this is size = (self.hidden_nodes)
    ...
    def forward_pass_train(self, X):
        ...
        print("Final input shapes: ", final_inputs.shape)
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        output_error_term = error #* final_outputs * (1 - final_outputs) # When f(x) = x, f'(x) = 1
        ...
        print((output_error_term[:, None] * hidden_outputs).shape)
        print((hidden_outputs * output_error_term[:, None]).T.shape)
        print((output_error_term * hidden_outputs[:, None]).shape)
    ...
    def run(self, features):
        ...
        hidden_outputs = self.activation_function(features) # signals from hidden layer
